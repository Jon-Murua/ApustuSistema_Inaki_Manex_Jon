...
public class CreateQuestionGUI extends JFrame {
	...
	private JLabel jLabelListOfEvents = new JLabel("Gertaeren lista");
	private JLabel jLabelQuery = new JLabel("Galdera");
	private JLabel jLabelMinBet = new JLabel("Apustu min");
	private JLabel jLabelEventDate = new JLabel("Gertaeraren eguna");
	...
	private JButton jButtonCreate = new JButton("Galdera sortu");
	...
	public CreateQuestionGUI(Vector<domain.Event> vector, JFrame logeatuta) {
		try {
			jbInit(vector,logeatuta);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	private void jbInit(Vector<domain.Event> v, JFrame logeatuta) throws Exception {

		this.getContentPane().setLayout(null);
		this.setSize(new Dimension(604, 370));
		this.setTitle("Galderak sortu");
		...
		jButtonClose.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				jButtonClose_actionPerformed(e,logeatuta);
			}
		});
...
//			    		  Component o=(Component) jCalendar.getDayChooser().getDayPanel().getComponent(i+offset);; 
	...
	private void jButtonClose_actionPerformed(ActionEvent e, JFrame logeatuta) {
