...
public class Question implements Serializable {
	...
	private ArrayList<Pronostikoa> proList= new ArrayList<Pronostikoa>();
   
	public ArrayList<Pronostikoa> getProList() {
		return proList;
	}

	public void setProList(ArrayList<Pronostikoa> proList) {
	...
	public void addPronostikoa(Pronostikoa p) {
		this.proList.add(p);
	}
